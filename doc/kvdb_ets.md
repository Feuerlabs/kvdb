...
`get_attrs(Db0, Table, Key, As) -> any()`
...
<a name="int_delete-2"></a>

###int_delete/2##


`int_delete(Db, Item) -> any()`
...
`int_read(Db, Item) -> any()`

<a name="int_write-3"></a>

###int_write/3##


`int_write(Db, Item, Value) -> any()`
...
`prefix_match(Db, Table, Prefix0, Limit) -> any()`
...
`save(Db, FileName) -> any()`

<a name="store_event-2"></a>

###store_event/2##


`store_event(Db, Event) -> any()`

<a name="switch_logs-2"></a>

###switch_logs/2##


`switch_logs(Db, LogInfo) -> any()`
