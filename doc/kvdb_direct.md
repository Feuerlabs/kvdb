...
<pre>get(Db::<a href="#type-db_ref">db_ref()</a>, Table::<a href="#type-table">table()</a>, Key::binary()) -> {ok, binary()} | {error, any()}</pre>
<br></br>
...
Low-level equivalent of [`index_get/4`](#index_get-4)<a name="info-2"></a>
